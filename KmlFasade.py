...
class KmlFasade(object):
    ...
    def createAdditionalGeometry(self, type, name='blank', coordin='0,0'):
        ...
        :param type: String, reading Point, LineString, or LinearRing.
        :param name: The name tag for the element. Simply for identification. Must be a String.
        :param coordin: The coordinates for the kml. Must be a String.
        :return:
        """
        if type == "Point":
