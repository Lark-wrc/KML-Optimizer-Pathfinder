...
class MergeGenerator(object):
    ...
    def __init__(self, outfile, base):
        ...
        :param base: The base image to compare to for each merge. Each image merged must be the same center and zoom
    ...
    def add(self, new):
        ...
        as a display of the output after each layer merge.
        :param new: A image with the same center and zoom as the class baseimage, which has lines or markers on it. It
